<?php if (!defined('THINK_PATH')) exit(); if(empty($houses)): ?><div class="message">
    ...
    <?php else: ?>
    <?php if(is_array($houses)): $i = 0; $__LIST__ = $houses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$house): $mod = ($i % 2 );++$i;?><div class="recommend-item"  onclick="javascript:window.location.href='<?php echo U('OldHouse/detail',array('id'=>$house['id']));?>'">
            ...
            <div class="houseInfo">
                ...
                <div class="attr">
                    <div class="left">
                        ...
                        <span><?php echo ($house["houseRoom"]); ?>室<?php echo ($house["livingRoom"]); ?>厅
                        | <?php echo renderNumber($house['square'],0);?>㎡</span>
                    </div>
                    <div class="right">
                        <span style="flex-direction: row">
                            <span class="money"><?php echo renderMoney($house['totalPrice']);?></span>
                            <span>万元/套</span>
                        </span>
                        <span class="submoney" style="flex-direction: row">
