...
<!-- /底部 -->
    ...
    <script type="text/javascript">
        ...
        $table.bootstrapTable({
            url: "<?php echo U('OldHouse/loadOldHouse');?>",
            toolbar: "#toolbar",
            search: true,
            showRefresh: true,
            showColumns: true,
            ...
            formatSearch: function(){return '请输入二手房名称'},
            height: getHeight(),
        ...
        $('#remove').click(function ()
        {
            ...
            function(){
                $.post("<?php echo U('/Admin/OldHouse/delete');?>", {ids:ids}, function(result) {
                    if(result.status==1){
                        swal({
                            title:"操作成功！",
                            text:result.info,
        ...
        $table.delegate('[name="edit"]','click', function ()
        {
            ...
            $("#Modal").modal({
                remote: "<?php echo U('/Admin/OldHouse/edit');?>?id="+id,
                backdrop: 'static',
                keyboard: false
            });
        });
        $('#add').click(function(){
            $("#Modal").modal({
                remote: "<?php echo U('/Admin/OldHouse/add');?>",
                backdrop: 'static',
                keyboard: false
            });
        });
        ...
        $table.delegate('[name="extra"]','click', function ()
        {
            var id = $(this).attr('data-id');
            $("#Modal").modal({
                remote: "<?php echo U('/Admin/OldHouse/editExtra');?>?id="+id,
                backdrop: 'static',
                keyboard: false
            });
        });
