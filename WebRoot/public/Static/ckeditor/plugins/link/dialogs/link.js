        ...
        return {
            title: b.title, minWidth: 350, minHeight: 230, contents: [{
                id: "info", label: b.info, title: b.info, elements: [{
                    ...
                    label: "Css Class", "default": "", setup: function (a) {
                        if (typeof a.advanced == "object" && typeof a.advanced.advCSSClasses == "string") {
                            this.setValue(a.advanced.advCSSClasses);
                        }
                    }, commit: function (a) {
                        a.class = this.getValue()
                    }
                }, {
